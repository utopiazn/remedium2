		...
		<table width="900" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td align="center"><h2>EVENT＊PROMOTION</h2>
					<hr align="center" width="50%" size="1" color="gray"></td>
			</tr>
			<tr>
				<td height="20"></td>
			</tr>
				...
				<table width="900" border="0" cellspacing="0" cellpadding="0"
					...
					<c:forEach items="${list}" var="row">
						<tr bgcolor="#FFFFFF" align="center">
							<td>${row.NO}</td>
							<td align="center">&nbsp; <a href="eventView?no=${row.NO}"> ${row.NAME} </a></td>
							<td align="center">${row.FIRSTDATE}</td>
							<td align="center">${row.LASTDATE}</td>
							<td align="center"><a
								href='eventModifyForm.action?no=${row.NO}'>수정</a>&nbsp;/ <a
								href='eventDelete.action?no=${row.NO}'>삭제</a></td>
						</tr>
						<tr bgcolor="#777777">
					...
					<%-- <s:iterator value="list">
						...
						<tr bgcolor="#FFFFFF" align="center">
							...
							<td align="center"><a
								href='eventModifyForm.action?no=<s:property value="no"/>'>수정</a>&nbsp;/
					...
					<tr align="right">
						<td colspan="5"><input class="button" type="button"
							value="글쓰기" class="inputb"
							onClick="javascript:location.href='eventInsertForm.action'">
						</td>
					</tr>
